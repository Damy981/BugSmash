...
func hide_box():
	...
	remove_child(characterNameLabel)
...
func setCharacterName(name):
	characterNameLabel = Label.new()
	characterNameLabel.text = name
	characterNameLabel.uppercase = true
	characterNameLabel.rect_size.x = 500
	characterNameLabel.rect_size.y = 30
	characterNameLabel.margin_left = 850
	characterNameLabel.margin_top = 470
	characterNameLabel.add_color_override("font_color", Color(0,0,0,1))
	characterNameLabel.add_font_override("font", nameFont)
