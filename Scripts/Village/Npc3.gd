...
func showDialog():
	if bdb.active == false:
		...
		bdb1.append_text("Quel mostro sembra aver paura di essere stanato da qualcuno", 5)
		setDialogBox("Abitante","Dicono che oltre il fiume i bug \nsiano sempre più aggressivi man mano ci si avvicina alla montagna…") 
