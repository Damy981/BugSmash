...
func callback():
	get_parent().get_parent().get_parent().get_parent().get_parent().get_node("ColorRectHelp").visible = true
	get_parent().get_node("SelectCursor").visible = false
	get_parent().get_parent().get_parent().get_parent().get_parent().get_node("ColorRectHelp/ScrollContainer/VBoxContainerM/MenuEntries/SelectCursorHelp").visible = true
